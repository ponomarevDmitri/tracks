 ...
 */
    ...
    <div class="modal fade" id="myModal">
            ...
            <form name="loginform" id="loginform" action="/j_spring_security_check" method="post">
                ...
                <div>
                    <label for="user_pass" class="loginFormTextLight">My Password:<br/>
                        <input type="password" name="j_password" id="user_pass" class="loginTextField" value=""
                               size="20"/></label>
                </div>
                <div id="rememberMe" class="loginFormTextLight">
                    <label for="rememberMeField"><input id="rememberMeField" name="rememberField" type="checkbox"
        ...
        <div class="modal-footer">
            <div id="lostPassword">
                <a href="http://www.templategarden.com/wp-login.php?action=lostpassword" title="Password Lost and Found"
                   class="loginFormTextBright">Забыли пароль?</a>
            </div>
            <div id="backtoblog">
                <a href="http://www.templategarden.com/" title="Are you lost?" class="loginFormTextBright">&larr;
                    Регистрация</a>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a style="height:40px; margin:5px;line-height:8px;color:white" id="signup-header-btn"
                       class="btn btn-success signupbtn" href="https://snappa.io/#" data-toggle="modal"
                       data-target="#loginModal" data-action="signup-form">Войти</a></li>
...
<div class="container" id="main_container">
            ...
            <div id="route_list_wrapper">
                <div id="editRouteToolsPane" style="margin: 15px 2px;">
                    ...
                    <div id="editRouteToolsContainer">
                        <div id="editCurrentPointButtons" class="actions-with-route-point-button-group"
                             style="display: none">
                            <span title="Добавить подробное описание" class="glyphicon glyphicon-wrench"
                        ...
                        <div id="createNewPointButtons" class="actions-with-route-point-button-group">
                            <button id="createNewPointButton" type="button"
                                    class="btn btn-primary create-new-point-button"
    ...
    <div class="row">
        <div id="editRouteRowModal" style="display: none;" class="col-lg-9 col-md-8">
            <div >
                <span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span>
            </div>
            <div>
                <input id="pointNameInput" type="text" class="form-control" placeholder="Название точки маршрута">
            </div>
            <div>
                <label for="pointDescrTextArea">Описание точки маршрута</label>
                <textarea id="pointDescrTextArea" class="form-control" rows="10"
...
<footer id="footer">
    <div class="container">
        <div class="row">
            ...
            <p>© 2014 Company, Inc. · <a href="http://bootstrap-3.ru/examples/carousel/#">Privacy</a> · <a
                    href="http://bootstrap-3.ru/examples/carousel/#">Terms</a></p>
        </div>
    </div>
</footer>
