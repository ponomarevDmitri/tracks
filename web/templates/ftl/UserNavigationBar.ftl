<#--<menu>-->
<#--    <ul>
        <li><a href="/user/user_route_list">Маршруты пользователя</a></li>
    </ul>-->
...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="/">TrucksHuyaks</a>
    </div>
    <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
            <li class="active"><a href="/user/user_route_list">Маршруты</a></li>
            <li class="active"><a href="/user/route/load">Загрузка маршрута</a></li>
